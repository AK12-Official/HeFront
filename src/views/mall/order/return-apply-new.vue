      ...
      <el-form :model="form" :rules="rules" ref="formRef" label-width="120px">
        ...
        <div class="section-card">
          ...
          <div class="product-info">
            <img :src="selectedProduct.productPic" :alt="selectedProduct.productName" class="product-image" />
        ...
        <div class="section-card">
          ...
          <el-form-item label="问题描述" prop="description">
            <el-input v-model="form.description" type="textarea" :rows="4" placeholder="请详细描述退货原因，例如：商品质量问题、尺寸不合适等"
