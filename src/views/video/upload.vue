  ...
  <div class="upload-page">
    ...
    <div class="video-upload-container">
      <div class="upload-card">
        ...
        <div class="upload-area" @click="triggerFileInput" @dragover.prevent="onDragOver"
          @dragleave.prevent="onDragLeave" @drop.prevent="onDrop" :class="{ 'drag-over': isDragOver }">
        ...
        <div class="form-section" v-if="selectedFile">
          <el-form :model="videoForm" label-position="top">
            ...
            <el-form-item label="视频描述">
              <el-input v-model="videoForm.description" type="textarea" placeholder="请输入视频描述" maxlength="200"
        ...
        <div class="action-buttons">
          ...
          <el-button v-if="isUploading && uploadId" type="danger" @click="handleCancelUpload" :icon="Delete">
            取消上传
          </el-button>
...
// 计算文件的SHA256哈希值（使用Web Crypto API）
...
const uploadVideo = async () => {
  ...
  try {
    ...
    const isLargeFile = fileSize > 40 * 1024 * 1024; // 40MB以上使用分块上传
